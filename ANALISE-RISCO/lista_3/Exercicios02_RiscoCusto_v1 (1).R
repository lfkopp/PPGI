...
custoOpcao[,1] <- custoOpcao[,1] / 10
custoOpcao[,2] <- custoOpcao[,2] / 10
custoOpcao[,3] <- custoOpcao[,3] / 10
custoOpcao[,4] <- custoOpcao[,4] / 10
custoOpcao[,5] <- custoOpcao[,5] / 10
custoOpcao[,6] <- custoOpcao[,6] / 10
